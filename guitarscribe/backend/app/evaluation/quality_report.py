...
def _boundary_f_measure(reference: list[float], estimated: list[float], tolerance: float = 0.25) -> float:
    if not reference:
    ...
    if annotation.chords:
        ...
        if len(estimated_intervals):
            ...
            chord = {
                ...
                "boundary_f_measure": _boundary_f_measure(
            ...
            chord = {"status": "no_estimated_chords", "fragmentation_ratio": 0.0}
